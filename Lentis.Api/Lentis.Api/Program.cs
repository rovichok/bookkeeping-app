...
app.Use(async (context, next) =>
{
    ...
    context.Response.Headers["Content-Security-Policy"] =
        ...
        "connect-src 'self' https://admin.lentisgroup.com https://api.lentisgroup.com https://*.ingest.sentry.io https://o4511436434636800.ingest.us.sentry.io; " + // Whitelists AJAX/Fetch API destinations.
